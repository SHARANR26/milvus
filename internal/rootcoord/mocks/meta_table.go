...
func (_m *IMetaTable) ReplaceCollectionWithTemp(ctx context.Context, dbName string, collectionName string, ts uint64) error {
	ret := _m.Called(ctx, dbName, collectionName, ts)
...
func (_c *IMetaTable_ReplaceCollectionWithTemp_Call) Return(_a1 error) *IMetaTable_ReplaceCollectionWithTemp_Call {
	_c.Call.Return(_a1)
	return _c
}

func (_c *IMetaTable_ReplaceCollectionWithTemp_Call) RunAndReturn(run func(ctx context.Context, dbName string, collectionName string, ts uint64) error) *IMetaTable_ReplaceCollectionWithTemp_Call {
	_c.Call.Return(run)
	return _c
}
