...
func (m mockMetaTable) ReplaceCollectionWithTemp(ctx context.Context, dbName string, collectionName string, ts Timestamp) error {
	return nil
}
...
func (b mockBroker) DropTempCollectionIndexes(ctx context.Context, collID UniqueID, partIDs []UniqueID) error {
	return b.DropCollectionIndexFunc(ctx, collID, partIDs)
}
